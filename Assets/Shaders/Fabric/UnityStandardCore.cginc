...
#include "MicroDetailFabricBRDF.cginc"
...
struct VertexOutputForwardBase
{
	...
	//half3 tangent			    : TEXCOORD10;
	//half3 bitangent			    : TEXCOORD11;
};
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	half4 c = MicroDetailFabricBRDF (s.diffColor, s.specColor, s.oneMinusReflectivity, s.oneMinusRoughness, s.normalWorld, -s.eyeVec, gi.light, gi.indirect,
									 i.tex.xy,
									 i.posWorld,
									 i.tangentToWorldAndParallax[0].xyz,
								     i.tangentToWorldAndParallax[1].xyz,
								     i.tangentToWorldAndParallax[2].xyz); 
...
half4 fragForwardAddInternal (VertexOutputForwardAdd i)
{
	...
	half4 c = MicroDetailFabricBRDF (s.diffColor, s.specColor, s.oneMinusReflectivity, s.oneMinusRoughness, s.normalWorld, -s.eyeVec, light, noIndirect,
									 i.tex.xy,
									 i.posWorld,
									 i.tangentToWorldAndLightDir[0].xyz,
									 i.tangentToWorldAndLightDir[1].xyz,
									 i.tangentToWorldAndLightDir[2].xyz);
...
)
{
	...
	half3 color = MicroDetailFabricBRDF (s.diffColor, s.specColor, s.oneMinusReflectivity, s.oneMinusRoughness, s.normalWorld, -s.eyeVec, gi.light, gi.indirect,
										 i.tex.xy,
										 i.posWorld,
										 i.tangentToWorldAndParallax[0].xyz,
										 i.tangentToWorldAndParallax[1].xyz,
										 i.tangentToWorldAndParallax[2].xyz).rgb;
